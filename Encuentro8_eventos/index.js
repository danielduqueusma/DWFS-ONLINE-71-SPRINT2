window.onload = function () {
  ...
  //--------------------------------------
  // 1. CREAR UN ELEMENTO EN EL HTML Y CAMBIAR EL COLOR DE TEXTO AL HACER OVER,
  //Y REMOVERLO AL SALIR DEL OVER (AGREGANDO Y REMOVIENDO CLASES)

  /**
   * 2. AL HACER CLICK EN ESE TEXTO, QUE SALGA UN PROMPT PARA INGRESAR
